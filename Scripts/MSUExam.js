    ...
    function populateFilters() {
        ...
        const fillSelect = (id, items) => {
            ...
            el.innerHTML = el.options[0].outerHTML; // Keep "Select..." option
        ...
        // Event Listeners for dynamic subject display based on class
    ...
    function updateSubjectDropdown(selectedClass, subjectElementId) {
        ...
        csvData.forEach(r => {
            if (r.Class === selectedClass && r.Subject) {
                filteredSubjects.add(r.Subject);
            }
        });
